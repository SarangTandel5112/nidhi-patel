...
const HeaderV2 = () => {
    ...
    return (
        <>
            <header>
                <nav
                    className={`navbar mobile-sidenav navbar-box navbar-default validnavs navbar-sticky on no-full ${
                    ...
                    <div className="container nav-box d-flex justify-content-between align-items-center">
                        ...
                        >
                            ...
                            >
                                ...
                                <li>
                                    <Link className="smooth-menu" to="/service">
                                        Services
                                    </Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link className="smooth-menu" to="/pricing">
                                        Pricing
                                    </Link>
                                </li>
                                <li>
